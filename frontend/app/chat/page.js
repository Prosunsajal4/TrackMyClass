...
export default function ChatPage() {
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: 'Hello! I\'m your AI attendance assistant. Ask me anything about attendance tracking, study tips, or academic advice!',
    },
  ]);
    ...
    <ProtectedRoute>
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <main className="flex-1 md:ml-64 p-4 md:p-6">
          ...
          <div className="mt-4 md:mt-8 max-w-4xl mx-auto h-[calc(100vh-200px)] md:h-[calc(100vh-250px)] flex flex-col">
            {/* Chat Messages */}
