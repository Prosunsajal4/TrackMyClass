...
export default function DashboardPage() {
  ...
  const doughnutData = {
    ...
    datasets: [
      {
        data: [stats.highRiskCourses, stats.mediumRiskCourses, stats.lowRiskCourses],
        ...
        <main className="flex-1 ml-64 p-6">
          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="glass-card rounded-xl p-6 animate-fadeIn" style={{ animationDelay: '0.3s' }}>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Risk Courses</p>
                    <p className="text-3xl font-bold text-gray-800 dark:text-white mt-2">
            ...
            <div className="glass-card rounded-xl p-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Predicted Attendance</p>
                  ...
                  <div className="flex items-center mt-2">
                    ...
                    <span className="text-sm ml-2 capitalize">{stats.prediction.trend}</span>
                  </div>
                </div>
                ...
                <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg">
                  ...
                  <p className="text-sm text-gray-500 mt-2">out of {stats.totalClasses} classes</p>
                </div>

                <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Next 5 Classes</p>
                  <p className="text-2xl font-bold text-purple-600 dark:text-purple-400 mt-2">
                    ~{stats.prediction.predictedAttended}
                  </p>
                  <p className="text-sm text-gray-500 mt-2">predicted attendance</p>
                </div>
              </div>
            </div>
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {course.stats.totalAttended}/{course.stats.totalClasses} classes attended
                        </p>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          ...
                          <p className="text-xs text-gray-500">{course.stats.totalMarks}/10 marks</p>
                        </div>
                        <div
